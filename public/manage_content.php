		...
		<div id="page">
			...
			<?php if ($current_subject) { ?>
				...
				<?php 
					...
					while($pagez = mysqli_fetch_assoc($subject_pages)) {
						echo "<li>";
						$safe_page_id = urlencode($pagez["id"]);
						echo "<a href=\"manage_content.php?page={$safe_page_id}\">";
						echo htmlentities($pagez["menu_name"]);
						echo "</a>";
						echo "</li>";
					}
				?>
				</ul>
				<a href="new_page.php?subject=<?php echo urlencode($current_subject["id"]); ?>">+ Add a page to <?php echo $current_subject["menu_name"]; ?></a>
